...
void TMVAClassificationApplication_BW(TString myMethodList = "" , TString iFileName = "", TString sampleLocation = "", TString outputLocation = "") 
{   
#ifdef __CINT__
   ...
   Float_t var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, var13, var14, var15, var16, var17, var18, var19, var20, var21, var22, var23, var24, var25, var26, var27;
   ...
   reader->AddVariable( "Alt$(bjet_pt_singleLepCalc[0],0)", &var4 );
   reader->AddVariable( "Alt$(bjet_pt_singleLepCalc[1],0)", &var5 );
   reader->AddVariable( "corr_met_singleLepCalc", &var6 );
   //reader->AddVariable( "muon_1_pt_singleLepCalc", &var7 );
   //reader->AddVariable( "n_btags_singleLepCalc", &var8 );
   ...
   //reader->AddVariable( "CAHEPTopJetMass_JetSubCalc", &var21 );
...
//    }
  ...
  reader->BookMVA("BDT method", weightFileName+".xml" ); 
   ...
   UInt_t nbin = 100;
   TH1F   *histBdt(0);
   histBdt = new TH1F( "MVA_BDT_BW",  "MVA_BDT_BW", nbin, -1.0, 1.0);
   ...
   Float_t BDT;
   TBranch *branchBDT = newTree->Branch("__BDT_BW__",&BDT,"__BDT_BW__/F");
   ...
   Double_t *dVar2, *dVar3, *dVar6, *dVar7, *dVar10, *dVar11, *dVar12, *dVar13, *dVar14, *dVar15, *dVar22, *dVar23, *dVar24, dVar25, *dVar26, *dVar27;
   theTree->SetBranchAddress( "jet_pt_singleLepCalc", &vecVar1);
   theTree->SetBranchAddress( "bjet_pt_singleLepCalc", &vecVar4 );
   theTree->SetBranchAddress( "corr_met_singleLepCalc", &dVar6 );
   theTree->SetBranchAddress( "muon_1_pt_singleLepCalc", &dVar7 );
   theTree->SetBranchAddress( "n_btags_singleLepCalc", &intVar8 );
   ...
   //theTree->SetBranchAddress( "CAHEPTopJetMass_JetSubCalc", &dVar21 ); <<--- if wanted back add as vector
