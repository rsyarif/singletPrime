...
void makeGraph(){
  ...
  leg = new TLegend(0.65,0.2,0.9,0.5);
  leg->SetFillStyle(0);
  leg->SetBorderSize(0);
  ...
  c2->Print("Plots/eff_vs_mass_mu.png");
  c2->Print("Plots/eff_vs_mass_mu.eps");
  c3->Print("Plots/eff_vs_mass_ele.png");
  c3->Print("Plots/eff_vs_mass_ele.eps");
