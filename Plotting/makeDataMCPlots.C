{
   ...
   std::string more_cuts =  "nSelJets_CommonCalc>1&&CA8Tau21_JetSubCalc[0]<0.5&&CA8JetPt_JetSubCalc>200";

   /*Folder to save in*/
   std::string parent_folder = "Plots";
   TString cmd = "mkdir "+parent_folder;
   gSystem->Exec(cmd);   
   std::string folder1 = "Plots_ALL";
   TString cmd ="mkdir "+parent_folder+"/"+folder1;
   gSystem->Exec(cmd);
   std::string folder2 = "Plots_THTZ_moreCuts";
   TString cmd ="mkdir "+parent_folder+"/"+folder2;
   gSystem->Exec(cmd);
   std::string folder3 = "Plots_BW_moreCuts";
   TString cmd ="mkdir "+parent_folder+"/"+folder3;
   gSystem->Exec(cmd);
   ...
   //makePlot("n_btages_singleLepCalc","ALL",6,0,6,mu_cut,"19300.","mu","BTagged Jets","",false,false,false,true,folder1);
